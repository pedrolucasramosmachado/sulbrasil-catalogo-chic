        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-3">
            ...
            {product.retail_price && (
              <div className="bg-pink-100 border border-pink-200 rounded-2xl p-3 flex flex-col items-center gap-1 transition-colors duration-300">
                <span className="text-[9px] font-semibold text-pink-400 uppercase tracking-widest">Varejo</span>
